...
class Repo(object):
    ...
    def __init__(self, full_name, description, html_url):
        ...
        self.origin_readme = ""
        self.description = self.filter_all(description)
        self.readme = []
    ...
    def retreive_data(self):
        page = requests.get(self.html_url).text
...
if __name__ == "__main__":
    ...
    n = 0
    while True:
        response = requests.get(api_url, auth=('XingyuGit', 'git631002'))
